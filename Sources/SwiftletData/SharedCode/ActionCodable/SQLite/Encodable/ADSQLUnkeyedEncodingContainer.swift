//
//  ADSQLUnkeyedEncodingContainer.swift
//  CoderPlayground
//
...
struct ADSQLUnkeyedEncodingContainer: UnkeyedEncodingContainer {
    ...
    /**
     ...
     - Parameters:
         - encoder: The parent `ADSQLEncoder` for the array being encoded.
         - codingPath: The path to the array being encoded.
         - container: The `ADInstanceArray` that the array is being encoded into.
    */
    init(referencing encoder: ADSQLEncoder, codingPath: [CodingKey], wrapping container: ADInstanceArray) {
    ...
    */
    mutating func superEncoder() -> Encoder {
        return ADSQLReferencingEncoder(referencing: encoder, at: container.storage.count, wrapping: container)
    }
