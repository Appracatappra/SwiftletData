//
//  ADSQLSingleValueEncodingContainer.swift
//  CoderPlayground
//
...
struct ADSQLSingleValueEncodingContainer: SingleValueEncodingContainer {
    ...
    /**
     ...
     - Parameters:
         - encoder: The `ADSQLEncoder` for this container.
    ...
    */
    init(referencing encoder: ADSQLEncoder, codingPath: [CodingKey], into storage: ADEncodingStorage) {
