//
//  ADSQLUnkeyedDecodingContainer.swift
//  CoderPlayground
//
...
struct ADSQLUnkeyedDecodingContainer: UnkeyedDecodingContainer {
    ...
    // MARK: - Initializers
    /**
     Initializes a new `ADSQLUnkeyedDecodingContainer` and sets its initial properties.
     - Parameters:
         - decoder: The parent `ADSQLDecoder`.
         - container: The array being decoded.
    */
    init(referencing decoder: ADSQLDecoder, wrapping container: [Any]) {
