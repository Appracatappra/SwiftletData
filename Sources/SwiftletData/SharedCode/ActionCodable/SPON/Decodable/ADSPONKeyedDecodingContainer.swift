//
//  ADSPONKeyedDecodingContainer.swift
//  ActionControls
//
...
struct ADSPONKeyedDecodingContainer<K: CodingKey>: KeyedDecodingContainerProtocol {
    ...
    // MARK: - Initializers
    /**
     Initializes a new instance of the `ADSPONKeyedDecodingContainer` and sets its initial properties.
     - Parameters:
         - decoder: The parent `ADSPONDecoder`.
         - container: The `ADRecord` being decoded.
     */
    init(referencing decoder: ADSPONDecoder, wrapping container: ADRecord) {
