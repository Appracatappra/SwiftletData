//
//  ADSPONSingleValueDecodingContainer.swift
//  ActionControls
//
...
struct ADSPONSingleValueDecodingContainer: SingleValueDecodingContainer {
    ...
    // MARK: - Initializers
    /**
     Initializes a new instance of the `ADSPONSingleValueDecodingContainer` and sets its initial properties.
     - Parameter decoder: The parent `ADSPONDecoder`.
     */
    init(referencing decoder: ADSPONDecoder) {
